...
const HELP = [
  ...
  { role:'rider', ic:IC.moto, tone:'var(--ink)', bg:'#ECEEED',
    ...
    topics:[
      { ic:IC.edit, h:{th:'สมัครเป็นไรเดอร์ส่งอาหาร',en:'Become a delivery rider'},
        s:{th:['ไปแท็บ “ฉัน” → “สมัครเป็นไรเดอร์ส่งอาหาร” จะพาไปหน้าสมัครของแพลตฟอร์ม',
               'สมัครกับแพลตฟอร์ม :Done KaiDee ครั้งเดียว รับงานได้จากทุกร้าน ไม่ใช่แค่ร้านนี้',
               'กรอก 4 ขั้น + ถ่ายเอกสาร (บัตร ปชช., ใบขับขี่, ทะเบียนรถ, พ.ร.บ., เซลฟี่คู่บัตร, หน้าบัญชี)',
               'ส่งแล้วทีมงานตรวจเอกสารและแจ้งผล · เช็คสถานะเองได้ด้วยเบอร์โทร',
               'ผ่านแล้วเข้าแอปไรเดอร์ ติดตั้งลงหน้าจอโฮมได้ ไม่ต้องโหลดจาก App Store'],
            en:['“Me” → “Become a delivery rider” — opens the platform signup',
                'One signup with :Done KaiDee — get jobs from every shop, not just this one',
                '4 steps + document photos (ID, licence, registration, insurance, selfie, bank book)',
                'Check your application status any time with your phone number',
                'Once approved, install the rider app to your home screen — no App Store needed']} },
